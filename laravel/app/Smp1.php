...
class Smp1 extends Model
{
    protected $table = 'smp1';
	protected $fillable = ['user_id','jalur','tanggal_masuk','bulan','status','fasilitas','namalengkap','avatar1','nisn1','nik1','tempatlahir1','tbt1','jenkel','desa','kec','kab','prov','kodepos1','cita1','jumlahsaudara1','asalsekolah1','alamatasalsekolah1','nokk1','namaayah1','nikayah1','tahunlahirayah1','pendidikanayah1','pekerjaanayah1','namaibu1','nikibu1','tahunlahiribu1','pendidikanibu1','pekerjaanibu1','penghasilan1','prestasi1','nohp1'];
...
//tambah foto
	public function getAvatar()
	{
		...
		return asset('images/' .$this->avatar1);
	}
//tambah foto
