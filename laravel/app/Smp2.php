...
class Smp2 extends Model
{
    protected $table = 'smp2';
	protected $fillable = ['user_id','jalur','tanggal_masuk','bulan','status','fasilitas','namalengkap','avatar2','nisn2','nik2','tempatlahir2','tbt2','jenkel','desa','kec','kab','prov','kodepos2','cita2','jumlahsaudara2','asalsekolah2','alamatasalsekolah2','nokk2','namaayah2','nikayah2','tahunlahirayah2','pendidikanayah2','pekerjaanayah2','namaibu2','nikibu2','tahunlahiribu2','pendidikanibu2','pekerjaanibu2','penghasilan2','prestasi2','nohp2'];
...
//tambah foto
	public function getAvatar()
	{
		...
		return asset('images/' .$this->avatar2);
	}
//tambah foto
