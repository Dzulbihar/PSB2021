	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp19->namalengkap19}} </th>
                    <th> {{ $smp19->status19}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp19->nisn19}} </th>
                    <th> {{ $smp19->nik19}} </th>
                    <th> {{ $smp19->tempatlahir19}} </th>
                    <th> {{ $smp19->tbt19}} </th>
                    <th> {{ $smp19->jenkel19}} </th>
                    <th> {{ $smp19->jumlahsaudara19}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp19->asalsekolah19}} </th>
                    <th> {{ $smp19->alamatasalsekolah19}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp19->nokk19}} </th>
                    <th> {{ $smp19->namaayah19}} </th>
                    <th> {{ $smp19->nikayah19}} </th>
                   <th> {{ $smp19->tahunlahirayah19}} </th>
                    <th> {{ $smp19->pendidikanayah19}} </th>
                    <th> {{ $smp19->pekerjaanayah19}} </th>
                    <th> {{ $smp19->namaibu19}} </th>
                    <th> {{ $smp19->nikibu19}} </th>
                    <th> {{ $smp19->tahunlahiribu19}} </th>
                    <th> {{ $smp19->pendidikanibu19}} </th>
                    <th> {{ $smp19->pekerjaanibu19}} </th>
                    <th> {{ $smp19->penghasilan19}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
