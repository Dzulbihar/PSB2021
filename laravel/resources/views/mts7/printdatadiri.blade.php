        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts7->nisn37}} </th>
                    <th> {{ $mts7->nik37}} </th>
                    <th> {{ $mts7->tempatlahir37}} </th>
                    <th> {{ $mts7->tbt37}} </th>
                    <th> {{ $mts7->jenkel37}} </th>
                    <th> {{ $mts7->jumlahsaudara37}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts7->asalsekolah37}} </th>
                    <th> {{ $mts7->alamatasalsekolah37}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts7->nokk37}} </th>
                    <th> {{ $mts7->namaayah37}} </th>
                    <th> {{ $mts7->nikayah37}} </th>
                   <th> {{ $mts7->tahunlahirayah37}} </th>
                    <th> {{ $mts7->pendidikanayah37}} </th>
                    <th> {{ $mts7->pekerjaanayah37}} </th>
                    <th> {{ $mts7->namaibu37}} </th>
                    <th> {{ $mts7->nikibu37}} </th>
                    <th> {{ $mts7->tahunlahiribu37}} </th>
                    <th> {{ $mts7->pendidikanibu37}} </th>
                    <th> {{ $mts7->pekerjaanibu37}} </th>
                    <th> {{ $mts7->penghasilan37}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
