        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            <div class="panel-heading">
              ...
              <h1 class="panel-title"><b> Daftar Nama yang Lunas Registrasi Biaya Awal Masuk Jenjang SMK TKJ </b></h1>
                ...
                <table class="table table-hover" id="datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> {{ $registrasi_smktkj->created_at}}  </td>
                    </tr>
                    @endforeach
