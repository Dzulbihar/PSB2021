...
<body>
	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          <br>
          <h3> <b> DATA PERIZINAN SANTRI </b> </h3>
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            <tr>
                      ...
                      <tr>
                        ...
                        <td> {{$izin->pivot->rumah}} </td>

                        <td> {{$izin->pivot->jangka}} </td>

                        <td> {{$izin->pivot->pondok}} </td>

                        <td> {{$izin->pivot->datang}} </td>

                        <td> {{$izin->pivot->hukum}} </td>

                        <td> {{$izin->pivot->ket}} </td>
