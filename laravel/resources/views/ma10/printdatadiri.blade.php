        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $ma10->nisn61}} </th>
                    <th> {{ $ma10->nik61}} </th>
                    <th> {{ $ma10->tempatlahir61}} </th>
                    <th> {{ $ma10->tbt61}} </th>
                    <th> {{ $ma10->jenkel61}} </th>
                    <th> {{ $ma10->jumlahsaudara61}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $ma10->asalsekolah61}} </th>
                    <th> {{ $ma10->alamatasalsekolah61}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $ma10->nokk61}} </th>
                    <th> {{ $ma10->namaayah61}} </th>
                    <th> {{ $ma10->nikayah61}} </th>
                   <th> {{ $ma10->tahunlahirayah61}} </th>
                    <th> {{ $ma10->pendidikanayah61}} </th>
                    <th> {{ $ma10->pekerjaanayah61}} </th>
                    <th> {{ $ma10->namaibu61}} </th>
                    <th> {{ $ma10->nikibu61}} </th>
                    <th> {{ $ma10->tahunlahiribu61}} </th>
                    <th> {{ $ma10->pendidikanibu61}} </th>
                    <th> {{ $ma10->pekerjaanibu61}} </th>
                    <th> {{ $ma10->penghasilan61}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
