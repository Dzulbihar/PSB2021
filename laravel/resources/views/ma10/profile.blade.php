...
<!-- ganti foto -->
							<img src="{{$ma10->getavatar()}}" width="100" class="img-circle" alt="avatar61">   
<!-- --------------- -->
							<h3 class="name">{{$ma10->namalengkap61}}</h3>
...
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<div class="text-center"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a></div>
					</div>
					<!-- END PROFILE DETAIL -->
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="{{ url('ma10') }}/{{$ma10->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printmapel')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> Nama Lengkap </b><span> {{ $ma10->namalengkap61}} </span></li>
									<li><b> Jenjang </b><span> {{ $ma10->status61}} </span></li>
									<li><b> NISN </b><span> {{ $ma10->nisn61}} </span></li>
									<li><b> NIK </b><span> {{ $ma10->nik61}} </span></li>
									<li><b> Tempat Lahir </b><span> {{ $ma10->tempatlahir61}} </span></li>
									<li><b> Tgl/Bulan/Tahun Lahir </b><span> {{ $ma10->tbt61}} </span></li>
									<li><b> Jenis Kelamin </b><span> {{ $ma10->jenkel61}} </span></li>
									<li><b> Desa </b><span> {{ $ma10->desa61}} </span></li>
									<li><b> Kecamatan </b><span> {{ $ma10->kec61}} </span></li>
									<li><b> Kabupaten </b><span> {{ $ma10->kab61}} </span></li>
									<li><b> Provinsi </b><span> {{ $ma10->prov61}} </span></li>
									<li><b> Kode Pos </b><span> {{ $ma10->kodepos61}} </span></li>
									<li><b> Alamat Lengkap </b><span> {{ $ma10->cita61}} </span></li>
									<li><b> Jumlah Saudara Kandung </b><span> {{ $ma10->jumlahsaudara61}} </span></li>
									<li><b> Asal Sekolah </b><span> {{ $ma10->asalsekolah61}} </span></li>
									<li><b> Alamat Asal Sekolah </b><span> {{ $ma10->alamatasalsekolah61}} </span></li>
								</ul>
							</div>

							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> No KK </b><span> {{ $ma10->nokk61}} </span></li>
									<li><b> Nama Ayah </b><span> {{ $ma10->namaayah61}} </span></li>
									<li><b> NIK Ayah </b><span> {{ $ma10->nikayah61}} </span></li>
									<li><b> Tahun Lahir Ayah </b><span> {{ $ma10->tahunlahirayah61}} </span></li>
									<li><b> Pendidikan Ayah </b><span> {{ $ma10->pendidikanayah61}} </span></li>
									<li><b> Pekerja Ayah </b><span> {{ $ma10->pekerjaanayah61}} </span></li>
									<li><b> Nama Ibu </b><span> {{ $ma10->namaibu61}} </span></li>
									<li><b> NIK Ibu </b><span> {{ $ma10->nikibu61}} </span></li>
									<li><b> Tahun Lahir Ibu </b><span> {{ $ma10->tahunlahiribu61}} </span></li>
									<li><b> Pendidikan Ibu </b><span> {{ $ma10->pendidikanibu61}} </span></li>
									<li><b> Pekerjaan Ibu </b><span> {{ $ma10->pekerjaanibu61}} </span></li>
									<li><b> Penghasilan Perbulan </b><span> {{ $ma10->penghasilan61}} </span></li>
									<li><b> Prestasi yang diraih </b><span> {{ $ma10->prestasi61}} </span></li>
									<li><b> No HP </b><span> {{ $ma10->nohp61}} </span></li>
								</ul>									
							</div>
							<div class="text-right"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printdatadiri')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade" id="tab-bottom-left3">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printhukuman')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left4">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printizin')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left5">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printambil')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left6">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printprestasi')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left7">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('ma10') }}/{{$ma10->id}}/{{('printcatatan')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('ma10')}}/{{$ma10->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
...
<!-- Nilai -->
		<div class="form-group {{$errors->has('namalengkap61') ? 'has-error' : ''}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('ma10')}}/{{$ma10->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('ma10')}}/{{$ma10->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('ma10')}}/{{$ma10->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('ma10')}}/{{$ma10->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('ma10')}}/{{$ma10->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
