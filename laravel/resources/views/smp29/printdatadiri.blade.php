	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp29->namalengkap29}} </th>
                    <th> {{ $smp29->status29}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp29->nisn29}} </th>
                    <th> {{ $smp29->nik29}} </th>
                    <th> {{ $smp29->tempatlahir29}} </th>
                    <th> {{ $smp29->tbt29}} </th>
                    <th> {{ $smp29->jenkel29}} </th>
                    <th> {{ $smp29->jumlahsaudara29}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp29->asalsekolah29}} </th>
                    <th> {{ $smp29->alamatasalsekolah29}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp29->nokk29}} </th>
                    <th> {{ $smp29->namaayah29}} </th>
                    <th> {{ $smp29->nikayah29}} </th>
                   <th> {{ $smp29->tahunlahirayah29}} </th>
                    <th> {{ $smp29->pendidikanayah29}} </th>
                    <th> {{ $smp29->pekerjaanayah29}} </th>
                    <th> {{ $smp29->namaibu29}} </th>
                    <th> {{ $smp29->nikibu29}} </th>
                    <th> {{ $smp29->tahunlahiribu29}} </th>
                    <th> {{ $smp29->pendidikanibu29}} </th>
                    <th> {{ $smp29->pekerjaanibu29}} </th>
                    <th> {{ $smp29->penghasilan29}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
