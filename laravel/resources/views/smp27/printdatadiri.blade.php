	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp27->namalengkap27}} </th>
                    <th> {{ $smp27->status27}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp27->nisn27}} </th>
                    <th> {{ $smp27->nik27}} </th>
                    <th> {{ $smp27->tempatlahir27}} </th>
                    <th> {{ $smp27->tbt27}} </th>
                    <th> {{ $smp27->jenkel27}} </th>
                    <th> {{ $smp27->jumlahsaudara27}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp27->asalsekolah27}} </th>
                    <th> {{ $smp27->alamatasalsekolah27}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp27->nokk27}} </th>
                    <th> {{ $smp27->namaayah27}} </th>
                    <th> {{ $smp27->nikayah27}} </th>
                   <th> {{ $smp27->tahunlahirayah27}} </th>
                    <th> {{ $smp27->pendidikanayah27}} </th>
                    <th> {{ $smp27->pekerjaanayah27}} </th>
                    <th> {{ $smp27->namaibu27}} </th>
                    <th> {{ $smp27->nikibu27}} </th>
                    <th> {{ $smp27->tahunlahiribu27}} </th>
                    <th> {{ $smp27->pendidikanibu27}} </th>
                    <th> {{ $smp27->pekerjaanibu27}} </th>
                    <th> {{ $smp27->penghasilan27}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
