	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp28->namalengkap28}} </th>
                    <th> {{ $smp28->status28}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp28->nisn28}} </th>
                    <th> {{ $smp28->nik28}} </th>
                    <th> {{ $smp28->tempatlahir28}} </th>
                    <th> {{ $smp28->tbt28}} </th>
                    <th> {{ $smp28->jenkel28}} </th>
                    <th> {{ $smp28->jumlahsaudara28}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp28->asalsekolah28}} </th>
                    <th> {{ $smp28->alamatasalsekolah28}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp28->nokk28}} </th>
                    <th> {{ $smp28->namaayah28}} </th>
                    <th> {{ $smp28->nikayah28}} </th>
                   <th> {{ $smp28->tahunlahirayah28}} </th>
                    <th> {{ $smp28->pendidikanayah28}} </th>
                    <th> {{ $smp28->pekerjaanayah28}} </th>
                    <th> {{ $smp28->namaibu28}} </th>
                    <th> {{ $smp28->nikibu28}} </th>
                    <th> {{ $smp28->tahunlahiribu28}} </th>
                    <th> {{ $smp28->pendidikanibu28}} </th>
                    <th> {{ $smp28->pekerjaanibu28}} </th>
                    <th> {{ $smp28->penghasilan28}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
