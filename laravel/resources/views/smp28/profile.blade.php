...
<!-- ganti foto -->
							<img src="{{$smp28->getavatar()}}" width="100" class="img-circle" alt="avatar28">   
<!-- --------------- -->
							<h3 class="name">{{$smp28->namalengkap28}}</h3>
						...
						<div class="profile-stat">
							<div class="row">
								<div class="col-md-4 stat-item">
									{{$smp28->mapel->count()}} <span>Mata Pelajaran</span>
								</div>
								<div class="col-md-4 stat-item">
									 <span>Data Pelanggaran</span>
								</div>
								<div class="col-md-4 stat-item">
									{{$smp28->rataRataNilai()}} <span>Total Nilai</span>
								</div>
							</div>
						</div>
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<div class="text-center"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a></div>
					</div>
					<!-- END PROFILE DETAIL -->
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->mapel as $mapel)
											<tr>
												<td>{{$mapel->kode}}</td>
												<td>{{$mapel->nama}}</td>
												<td>{{$mapel->kelas}}</td>
												<td> <a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editnilai')}}" data-title="Masukan Nilai">{{$mapel->pivot->nilai}}</a>  </td>
												<td><a href="{{ url('smp28') }}/{{$smp28->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printmapel')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li> Nama Lengkap <span> {{ $smp28->namalengkap28}} </span></li>
									<li> NISN <span> {{ $smp28->nisn28}} </span></li>
									<li> NIK <span> {{ $smp28->nik28}} </span></li>
									<li> Tempat Lahir <span> {{ $smp28->tempatlahir28}} </span></li>
									<li> Tgl/Bulan/Tahun Lahir <span> {{ $smp28->tbt28}} </span></li>
									<li> Jenis Kelamin <span> {{ $smp28->jenkel28}} </span></li>
									<li> Desa <span> {{ $smp28->desa28}} </span></li>
									<li> Kecamatan <span> {{ $smp28->kec28}} </span></li>
									<li> Kabupaten <span> {{ $smp28->kab28}} </span></li>
									<li> Provinsi <span> {{ $smp28->prov28}} </span></li>
									<li> Kode Pos <span> {{ $smp28->kodepos28}} </span></li>
									<li> Alamat Lengkap <span> {{ $smp28->cita28}} </span></li>
									<li> Jumlah Saudara Kandung <span> {{ $smp28->jumlahsaudara28}} </span></li>
									<li> Asal Sekolah <span> {{ $smp28->asalsekolah28}} </span></li>
									<li> Alamat Asal Sekolah <span> {{ $smp28->alamatasalsekolah28}} </span></li>
								</ul>
							</div>

							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li> No KK <span> {{ $smp28->nokk28}} </span></li>
									<li> Nama Ayah <span> {{ $smp28->namaayah28}} </span></li>
									<li> NIK Ayah <span> {{ $smp28->nikayah28}} </span></li>
									<li> Tahun Lahir Ayah <span> {{ $smp28->tahunlahirayah28}} </span></li>
									<li> Pendidikan Ayah <span> {{ $smp28->pendidikanayah28}} </span></li>
									<li> Pekerja Ayah <span> {{ $smp28->pekerjaanayah28}} </span></li>
									<li> Nama Ibu <span> {{ $smp28->namaibu28}} </span></li>
									<li> NIK Ibu <span> {{ $smp28->nikibu28}} </span></li>
									<li> Tahun Lahir Ibu <span> {{ $smp28->tahunlahiribu28}} </span></li>
									<li> Pendidikan Ibu <span> {{ $smp28->pendidikanibu28}} </span></li>
									<li> Pekerjaan Ibu <span> {{ $smp28->pekerjaanibu28}} </span></li>
									<li> Penghasilan Perbulan <span> {{ $smp28->penghasilan28}} </span></li>
									<li> Prestasi yang diraih <span> {{ $smp28->prestasi28}} </span></li>
									<li> No HP <span> {{ $smp28->nohp28}} </span></li>
								</ul>									
							</div>
							<div class="text-right"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printdatadiri')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->hukuman as $hukuman)
											<tr>
												<td>{{$hukuman->pelanggaran}}</td>

												<td> <a href="#" class="jenis" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editjenis')}}" data-title="Masukan Data">{{$hukuman->pivot->jenis}}</a>  </td>

												<td> <a href="#" class="sanksi" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editsanksi')}}" data-title="Masukan Data">{{$hukuman->pivot->sanksi}}</a>  </td>

												<td> <a href="#" class="skor" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editskor')}}" data-title="Masukan Data">{{$hukuman->pivot->skor}}</a>  </td>

												<td> <a href="#" class="data" data-type="date" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editdata')}}" data-title="Masukan Data">{{$hukuman->pivot->data}}</a>  </td>

											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printhukuman')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->izin as $izin)
											<tr>
												<td>{{$izin->keperluan}}</td>


												<td> <a href="#" class="rumah" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editrumah')}}" data-title="Masukan Data">{{$izin->pivot->rumah}}</a>  </td>

												<td> <a href="#" class="jangka" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editjangka')}}" data-title="Masukan Data">{{$izin->pivot->jangka}}</a>  </td>

												<td> <a href="#" class="pondok" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editpondok')}}" data-title="Masukan Data">{{$izin->pivot->pondok}}</a>  </td>

												<td> <a href="#" class="datang" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editdatang')}}" data-title="Masukan Data">{{$izin->pivot->datang}}</a>  </td>

												<td> <a href="#" class="hukum" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('edithukum')}}" data-title="Masukan Data">{{$izin->pivot->hukum}}</a>  </td>

												<td> <a href="#" class="ket" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editket')}}" data-title="Masukan Data">{{$izin->pivot->ket}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printizin')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->ambil as $ambil)
											<tr>
												<td>{{$ambil->barang}}</td>

												<td> <a href="#" class="pelunasan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editpelunasan')}}" data-title="Masukan Data">{{$ambil->pivot->pelunasan}}</a>  </td>

												<td> <a href="#" class="pengambilan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editpengambilan')}}" data-title="Masukan Data">{{$ambil->pivot->pengambilan}}</a>  </td>

												<td> <a href="#" class="keterangan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editketerangan')}}" data-title="Masukan Data">{{$ambil->pivot->keterangan}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printambil')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->prestasi as $prestasi)
											<tr>
												<td>{{$prestasi->juara}}</td>

												<td> <a href="#" class="tingkat" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('edittingkat')}}" data-title="Masukan Data">{{$prestasi->pivot->tingkat}}</a>  </td>

												<td> <a href="#" class="kategori" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editkategori')}}" data-title="Masukan Data">{{$prestasi->pivot->kategori}}</a>  </td>

												<td> <a href="#" class="hadiah" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('edithadiah')}}" data-title="Masukan Data">{{$prestasi->pivot->hadiah}}</a>  </td>

												<td> <a href="#" class="waktu" data-type="date" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editwaktu')}}" data-title="Masukan Data">{{$prestasi->pivot->waktu}}</a>  </td>

												<td> <a href="#" class="note" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editnote')}}" data-title="Masukan Data">{{$prestasi->pivot->note}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printprestasi')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp28->catatan as $catatan)
											<tr>
												<td>{{$catatan->note}}</td>

												<td> <a href="#" class="sifat" data-type="text" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editsifat')}}" data-title="Masukan Data">{{$catatan->pivot->sifat}}</a>  </td>

												<td> <a href="#" class="nulis" data-type="date" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smp28') }}/{{$smp28->id}}/{{('editnulis')}}" data-title="Masukan Data">{{$catatan->pivot->nulis}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smp28') }}/{{$smp28->id}}/{{('printcatatan')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('smp28')}}/{{$smp28->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
...
<!-- Nilai -->
		<div class="form-group {{$errors->has('namalengkap28') ? 'has-error' : ''}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp28')}}/{{$smp28->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp28')}}/{{$smp28->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp28')}}/{{$smp28->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp28')}}/{{$smp28->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp28')}}/{{$smp28->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
