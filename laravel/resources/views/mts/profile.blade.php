...
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<a href="{{ url('mts') }}/{{$mts->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a>

						<a href="{{ url('mts') }}/{{$mts->id}}/{{('seratusribu')}}" target="_blank" class="btn btn-success float-right"></i> Print Biaya Registrasi </a>

						<a href="{{ url('mts') }}/{{$mts->id}}/{{('printmts')}}" target="_blank" class="btn btn-success float-right"></i> Print Data diri </a>

						<a href="{{ url('mts') }}/{{$mts->id}}/{{('biayaawalmasuk')}}" target="_blank" class="btn btn-danger float-right"></i> Biaya Awal Masuk </a>
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="{{ url('mts') }}/{{$mts->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('mts')}}/{{$mts->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('mts')}}/{{$mts->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('mts')}}/{{$mts->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('mts')}}/{{$mts->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('mts')}}/{{$mts->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('mts')}}/{{$mts->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
