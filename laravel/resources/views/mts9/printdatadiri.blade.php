        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts9->nisn39}} </th>
                    <th> {{ $mts9->nik39}} </th>
                    <th> {{ $mts9->tempatlahir39}} </th>
                    <th> {{ $mts9->tbt39}} </th>
                    <th> {{ $mts9->jenkel39}} </th>
                    <th> {{ $mts9->jumlahsaudara39}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts9->asalsekolah39}} </th>
                    <th> {{ $mts9->alamatasalsekolah39}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts9->nokk39}} </th>
                    <th> {{ $mts9->namaayah39}} </th>
                    <th> {{ $mts9->nikayah39}} </th>
                   <th> {{ $mts9->tahunlahirayah39}} </th>
                    <th> {{ $mts9->pendidikanayah39}} </th>
                    <th> {{ $mts9->pekerjaanayah39}} </th>
                    <th> {{ $mts9->namaibu39}} </th>
                    <th> {{ $mts9->nikibu39}} </th>
                    <th> {{ $mts9->tahunlahiribu39}} </th>
                    <th> {{ $mts9->pendidikanibu39}} </th>
                    <th> {{ $mts9->pekerjaanibu39}} </th>
                    <th> {{ $mts9->penghasilan39}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
