        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $salaf->nisn0}} </th>
                    <th> {{ $salaf->nik0}} </th>
                    <th> {{ $salaf->tempatlahir0}} </th>
                    <th> {{ $salaf->tbt0}} </th>
                    <th> {{ $salaf->jenkel0}} </th>
                    <th> {{ $salaf->jumlahsaudara0}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $salaf->asalsekolah0}} </th>
                    <th> {{ $salaf->alamatasalsekolah0}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $salaf->nokk0}} </th>
                    <th> {{ $salaf->namaayah0}} </th>
                    <th> {{ $salaf->nikayah0}} </th>
                   <th> {{ $salaf->tahunlahirayah0}} </th>
                    <th> {{ $salaf->pendidikanayah0}} </th>
                    <th> {{ $salaf->pekerjaanayah0}} </th>
                    <th> {{ $salaf->namaibu0}} </th>
                    <th> {{ $salaf->nikibu0}} </th>
                    <th> {{ $salaf->tahunlahiribu0}} </th>
                    <th> {{ $salaf->pendidikanibu0}} </th>
                    <th> {{ $salaf->pekerjaanibu0}} </th>
                    <th> {{ $salaf->penghasilan0}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
