...
<!-- ganti foto -->
							<img src="{{$smktkr10->getavatar()}}" width="100" class="img-circle" alt="avatar51">   
<!-- --------------- -->
							<h3 class="name">{{$smktkr10->namalengkap51}}</h3>
						...
						<div class="profile-stat">
							<div class="row">
								<div class="col-md-4 stat-item">
									{{$smktkr10->mapel->count()}} <span>Mata Pelajaran</span>
								</div>
								<div class="col-md-4 stat-item">
									 <span>Data Pelanggaran</span>
								</div>
								<div class="col-md-4 stat-item">
									{{$smktkr10->rataRataNilai()}} <span>Total Nilai</span>
								</div>
							</div>
						</div>
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<div class="text-center"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a></div>
					</div>
					<!-- END PROFILE DETAIL -->
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->mapel as $mapel)
											<tr>
												<td>{{$mapel->kode}}</td>
												<td>{{$mapel->nama}}</td>
												<td>{{$mapel->kelas}}</td>
												<td> <a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editnilai')}}" data-title="Masukan Nilai">{{$mapel->pivot->nilai}}</a>  </td>
												<td><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printmapel')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> Nama Lengkap </b><span> {{ $smktkr10->namalengkap51}} </span></li>
									<li><b> Jenjang </b><span> {{ $smktkr10->status51}} </span></li>
									<li><b> NISN </b><span> {{ $smktkr10->nisn51}} </span></li>
									<li><b> NIK </b><span> {{ $smktkr10->nik51}} </span></li>
									<li><b> Tempat Lahir </b><span> {{ $smktkr10->tempatlahir51}} </span></li>
									<li><b> Tgl/Bulan/Tahun Lahir </b><span> {{ $smktkr10->tbt51}} </span></li>
									<li><b> Jenis Kelamin </b><span> {{ $smktkr10->jenkel51}} </span></li>
									<li><b> Desa </b><span> {{ $smktkr10->desa51}} </span></li>
									<li><b> Kecamatan </b><span> {{ $smktkr10->kec51}} </span></li>
									<li><b> Kabupaten </b><span> {{ $smktkr10->kab51}} </span></li>
									<li><b> Provinsi </b><span> {{ $smktkr10->prov51}} </span></li>
									<li><b> Kode Pos </b><span> {{ $smktkr10->kodepos51}} </span></li>
									<li><b> Alamat Lengkap </b><span> {{ $smktkr10->cita51}} </span></li>
									<li><b> Jumlah Saudara Kandung </b><span> {{ $smktkr10->jumlahsaudara51}} </span></li>
									<li><b> Asal Sekolah </b><span> {{ $smktkr10->asalsekolah51}} </span></li>
									<li><b> Alamat Asal Sekolah </b><span> {{ $smktkr10->alamatasalsekolah51}} </span></li>
								</ul>
							</div>

							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> No KK </b><span> {{ $smktkr10->nokk51}} </span></li>
									<li><b> Nama Ayah </b><span> {{ $smktkr10->namaayah51}} </span></li>
									<li><b> NIK Ayah </b><span> {{ $smktkr10->nikayah51}} </span></li>
									<li><b> Tahun Lahir Ayah </b><span> {{ $smktkr10->tahunlahirayah51}} </span></li>
									<li><b> Pendidikan Ayah </b><span> {{ $smktkr10->pendidikanayah51}} </span></li>
									<li><b> Pekerja Ayah </b><span> {{ $smktkr10->pekerjaanayah51}} </span></li>
									<li><b> Nama Ibu </b><span> {{ $smktkr10->namaibu51}} </span></li>
									<li><b> NIK Ibu </b><span> {{ $smktkr10->nikibu51}} </span></li>
									<li><b> Tahun Lahir Ibu </b><span> {{ $smktkr10->tahunlahiribu51}} </span></li>
									<li><b> Pendidikan Ibu </b><span> {{ $smktkr10->pendidikanibu51}} </span></li>
									<li><b> Pekerjaan Ibu </b><span> {{ $smktkr10->pekerjaanibu51}} </span></li>
									<li><b> Penghasilan Perbulan </b><span> {{ $smktkr10->penghasilan51}} </span></li>
									<li><b> Prestasi yang diraih </b><span> {{ $smktkr10->prestasi51}} </span></li>
									<li><b> No HP </b><span> {{ $smktkr10->nohp51}} </span></li>
								</ul>									
							</div>
							<div class="text-right"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printdatadiri')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->hukuman as $hukuman)
											<tr>
												<td>{{$hukuman->pelanggaran}}</td>

												<td> <a href="#" class="jenis" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editjenis')}}" data-title="Masukan Data">{{$hukuman->pivot->jenis}}</a>  </td>

												<td> <a href="#" class="sanksi" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editsanksi')}}" data-title="Masukan Data">{{$hukuman->pivot->sanksi}}</a>  </td>

												<td> <a href="#" class="skor" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editskor')}}" data-title="Masukan Data">{{$hukuman->pivot->skor}}</a>  </td>

												<td> <a href="#" class="data" data-type="date" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editdata')}}" data-title="Masukan Data">{{$hukuman->pivot->data}}</a>  </td>

											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printhukuman')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->izin as $izin)
											<tr>
												<td>{{$izin->keperluan}}</td>


												<td> <a href="#" class="rumah" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editrumah')}}" data-title="Masukan Data">{{$izin->pivot->rumah}}</a>  </td>

												<td> <a href="#" class="jangka" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editjangka')}}" data-title="Masukan Data">{{$izin->pivot->jangka}}</a>  </td>

												<td> <a href="#" class="pondok" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editpondok')}}" data-title="Masukan Data">{{$izin->pivot->pondok}}</a>  </td>

												<td> <a href="#" class="datang" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editdatang')}}" data-title="Masukan Data">{{$izin->pivot->datang}}</a>  </td>

												<td> <a href="#" class="hukum" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('edithukum')}}" data-title="Masukan Data">{{$izin->pivot->hukum}}</a>  </td>

												<td> <a href="#" class="ket" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editket')}}" data-title="Masukan Data">{{$izin->pivot->ket}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printizin')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->ambil as $ambil)
											<tr>
												<td>{{$ambil->barang}}</td>

												<td> <a href="#" class="pelunasan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editpelunasan')}}" data-title="Masukan Data">{{$ambil->pivot->pelunasan}}</a>  </td>

												<td> <a href="#" class="pengambilan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editpengambilan')}}" data-title="Masukan Data">{{$ambil->pivot->pengambilan}}</a>  </td>

												<td> <a href="#" class="keterangan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editketerangan')}}" data-title="Masukan Data">{{$ambil->pivot->keterangan}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printambil')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->prestasi as $prestasi)
											<tr>
												<td>{{$prestasi->juara}}</td>

												<td> <a href="#" class="tingkat" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('edittingkat')}}" data-title="Masukan Data">{{$prestasi->pivot->tingkat}}</a>  </td>

												<td> <a href="#" class="kategori" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editkategori')}}" data-title="Masukan Data">{{$prestasi->pivot->kategori}}</a>  </td>

												<td> <a href="#" class="hadiah" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('edithadiah')}}" data-title="Masukan Data">{{$prestasi->pivot->hadiah}}</a>  </td>

												<td> <a href="#" class="waktu" data-type="date" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editwaktu')}}" data-title="Masukan Data">{{$prestasi->pivot->waktu}}</a>  </td>

												<td> <a href="#" class="note" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editnote')}}" data-title="Masukan Data">{{$prestasi->pivot->note}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printprestasi')}}" target="_blank" class="btn btn-success"> Print </a></div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr10->catatan as $catatan)
											<tr>
												<td>{{$catatan->note}}</td>

												<td> <a href="#" class="sifat" data-type="text" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editsifat')}}" data-title="Masukan Data">{{$catatan->pivot->sifat}}</a>  </td>

												<td> <a href="#" class="nulis" data-type="date" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smktkr10') }}/{{$smktkr10->id}}/{{('editnulis')}}" data-title="Masukan Data">{{$catatan->pivot->nulis}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smktkr10') }}/{{$smktkr10->id}}/{{('printcatatan')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
...
<!-- Nilai -->
		<div class="form-group {{$errors->has('namalengkap51') ? 'has-error' : ''}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr10')}}/{{$smktkr10->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
