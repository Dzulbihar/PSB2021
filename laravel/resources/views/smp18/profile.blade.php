...
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<div class="text-center"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a></div>
					</div>
					<!-- END PROFILE DETAIL -->
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="{{ url('smp18') }}/{{$smp18->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printmapel')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="text-right"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printdatadiri')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade" id="tab-bottom-left3">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printhukuman')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>
						...
						<div class="tab-pane fade " id="tab-bottom-left4">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printizin')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>							
						...
						<div class="tab-pane fade " id="tab-bottom-left5">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printambil')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left6">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printprestasi')}}" target="_blank" class="btn btn-success"> Print </a></div>
						...
						<div class="tab-pane fade " id="tab-bottom-left7">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="text-left"><a href="{{ url('smp18') }}/{{$smp18->id}}/{{('printcatatan')}}" target="_blank" class="btn btn-success"> Print </a></div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('smp18')}}/{{$smp18->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
...
<!-- Nilai -->
		<div class="form-group {{$errors->has('namalengkap18') ? 'has-error' : ''}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp18')}}/{{$smp18->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp18')}}/{{$smp18->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp18')}}/{{$smp18->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp18')}}/{{$smp18->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp18')}}/{{$smp18->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
