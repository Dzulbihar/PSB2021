	...
	<div class="wrapper">
        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp17->namalengkap17}} </th>
                    <th> {{ $smp17->status17}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp17->nisn17}} </th>
                    <th> {{ $smp17->nik17}} </th>
                    <th> {{ $smp17->tempatlahir17}} </th>
                    <th> {{ $smp17->tbt17}} </th>
                    <th> {{ $smp17->jenkel17}} </th>
                    <th> {{ $smp17->jumlahsaudara17}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp17->asalsekolah17}} </th>
                    <th> {{ $smp17->alamatasalsekolah17}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $smp17->nokk17}} </th>
                    <th> {{ $smp17->namaayah17}} </th>
                    <th> {{ $smp17->nikayah17}} </th>
                   <th> {{ $smp17->tahunlahirayah17}} </th>
                    <th> {{ $smp17->pendidikanayah17}} </th>
                    <th> {{ $smp17->pekerjaanayah17}} </th>
                    <th> {{ $smp17->namaibu17}} </th>
                    <th> {{ $smp17->nikibu17}} </th>
                    <th> {{ $smp17->tahunlahiribu17}} </th>
                    <th> {{ $smp17->pendidikanibu17}} </th>
                    <th> {{ $smp17->pekerjaanibu17}} </th>
                    <th> {{ $smp17->penghasilan17}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
