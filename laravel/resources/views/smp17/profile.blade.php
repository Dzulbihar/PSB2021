...
<!-- ganti foto -->
							<img src="{{$smp17->getavatar()}}" width="100" class="img-circle" alt="avatar17">   
<!-- --------------- -->
							<h3 class="name">{{$smp17->namalengkap17}}</h3>
						...
						<div class="profile-stat">
							<div class="row">
								<div class="col-md-4 stat-item">
									{{$smp17->mapel->count()}} <span>Mata Pelajaran</span>
								</div>
								<div class="col-md-4 stat-item">
									 <span>Data Pelanggaran</span>
								</div>
								<div class="col-md-4 stat-item">
									{{$smp17->rataRataNilai()}} <span>Total Nilai</span>
								</div>
							</div>
						</div>
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<div class="text-center"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a></div>
					</div>
					<!-- END PROFILE DETAIL -->
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->mapel as $mapel)
											<tr>
												<td>{{$mapel->kode}}</td>
												<td>{{$mapel->nama}}</td>
												<td>{{$mapel->kelas}}</td>
												<td> <a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editnilai')}}" data-title="Masukan Nilai">{{$mapel->pivot->nilai}}</a>  </td>
												<td><a href="{{ url('smp17') }}/{{$smp17->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printmapel')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> Nama Lengkap </b><span> {{ $smp17->namalengkap17}} </span></li>
									<li><b> Jenjang </b><span> {{ $smp17->status17}} </span></li>
									<li><b> NISN </b><span> {{ $smp17->nisn17}} </span></li>
									<li><b> NIK </b><span> {{ $smp17->nik17}} </span></li>
									<li><b> Tempat Lahir </b><span> {{ $smp17->tempatlahir17}} </span></li>
									<li><b> Tgl/Bulan/Tahun Lahir </b><span> {{ $smp17->tbt17}} </span></li>
									<li><b> Jenis Kelamin </b><span> {{ $smp17->jenkel17}} </span></li>
									<li><b> Desa </b><span> {{ $smp17->desa17}} </span></li>
									<li><b> Kecamatan </b><span> {{ $smp17->kec17}} </span></li>
									<li><b> Kabupaten </b><span> {{ $smp17->kab17}} </span></li>
									<li><b> Provinsi </b><span> {{ $smp17->prov17}} </span></li>
									<li><b> Kode Pos </b><span> {{ $smp17->kodepos17}} </span></li>
									<li><b> Alamat Lengkap </b><span> {{ $smp17->cita17}} </span></li>
									<li><b> Jumlah Saudara Kandung </b><span> {{ $smp17->jumlahsaudara17}} </span></li>
									<li><b> Asal Sekolah </b><span> {{ $smp17->asalsekolah17}} </span></li>
									<li><b> Alamat Asal Sekolah </b><span> {{ $smp17->alamatasalsekolah17}} </span></li>
								</ul>
							</div>

							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li><b> No KK </b><span> {{ $smp17->nokk17}} </span></li>
									<li><b> Nama Ayah </b><span> {{ $smp17->namaayah17}} </span></li>
									<li><b> NIK Ayah </b><span> {{ $smp17->nikayah17}} </span></li>
									<li><b> Tahun Lahir Ayah </b><span> {{ $smp17->tahunlahirayah17}} </span></li>
									<li><b> Pendidikan Ayah </b><span> {{ $smp17->pendidikanayah17}} </span></li>
									<li><b> Pekerja Ayah </b><span> {{ $smp17->pekerjaanayah17}} </span></li>
									<li><b> Nama Ibu </b><span> {{ $smp17->namaibu17}} </span></li>
									<li><b> NIK Ibu </b><span> {{ $smp17->nikibu17}} </span></li>
									<li><b> Tahun Lahir Ibu </b><span> {{ $smp17->tahunlahiribu17}} </span></li>
									<li><b> Pendidikan Ibu </b><span> {{ $smp17->pendidikanibu17}} </span></li>
									<li><b> Pekerjaan Ibu </b><span> {{ $smp17->pekerjaanibu17}} </span></li>
									<li><b> Penghasilan Perbulan </b><span> {{ $smp17->penghasilan17}} </span></li>
									<li><b> Prestasi yang diraih </b><span> {{ $smp17->prestasi17}} </span></li>
									<li><b> No HP </b><span> {{ $smp17->nohp17}} </span></li>
								</ul>									
							</div>
							<div class="text-right"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printdatadiri')}}" target="_blank" class="btn btn-success"> Print </a></div>
						</div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->hukuman as $hukuman)
											<tr>
												<td>{{$hukuman->pelanggaran}}</td>

												<td> <a href="#" class="jenis" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editjenis')}}" data-title="Masukan Data">{{$hukuman->pivot->jenis}}</a>  </td>

												<td> <a href="#" class="sanksi" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editsanksi')}}" data-title="Masukan Data">{{$hukuman->pivot->sanksi}}</a>  </td>

												<td> <a href="#" class="skor" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editskor')}}" data-title="Masukan Data">{{$hukuman->pivot->skor}}</a>  </td>

												<td> <a href="#" class="data" data-type="date" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editdata')}}" data-title="Masukan Data">{{$hukuman->pivot->data}}</a>  </td>

											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printhukuman')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->izin as $izin)
											<tr>
												<td>{{$izin->keperluan}}</td>

												<td> <a href="#" class="rumah" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editrumah')}}" data-title="Masukan Data">{{$izin->pivot->rumah}}</a>  </td>

												<td> <a href="#" class="jangka" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editjangka')}}" data-title="Masukan Data">{{$izin->pivot->jangka}}</a>  </td>

												<td> <a href="#" class="pondok" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editpondok')}}" data-title="Masukan Data">{{$izin->pivot->pondok}}</a>  </td>

												<td> <a href="#" class="datang" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editdatang')}}" data-title="Masukan Data">{{$izin->pivot->datang}}</a>  </td>

												<td> <a href="#" class="hukum" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('edithukum')}}" data-title="Masukan Data">{{$izin->pivot->hukum}}</a>  </td>

												<td> <a href="#" class="ket" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editket')}}" data-title="Masukan Data">{{$izin->pivot->ket}}</a>  </td>

											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printizin')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>							
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->ambil as $ambil)
											<tr>
												<td>{{$ambil->barang}}</td>

												<td> <a href="#" class="pelunasan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editpelunasan')}}" data-title="Masukan Data">{{$ambil->pivot->pelunasan}}</a>  </td>

												<td> <a href="#" class="pengambilan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editpengambilan')}}" data-title="Masukan Data">{{$ambil->pivot->pengambilan}}</a>  </td>

												<td> <a href="#" class="keterangan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editketerangan')}}" data-title="Masukan Data">{{$ambil->pivot->keterangan}}</a>  </td>

											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printambil')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>							
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->prestasi as $prestasi)
											<tr>
												<td>{{$prestasi->juara}}</td>

												<td> <a href="#" class="tingkat" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('edittingkat')}}" data-title="Masukan Data">{{$prestasi->pivot->tingkat}}</a>  </td>

												<td> <a href="#" class="kategori" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editkategori')}}" data-title="Masukan Data">{{$prestasi->pivot->kategori}}</a>  </td>

												<td> <a href="#" class="hadiah" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('edithadiah')}}" data-title="Masukan Data">{{$prestasi->pivot->hadiah}}</a>  </td>

												<td> <a href="#" class="waktu" data-type="date" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editwaktu')}}" data-title="Masukan Data">{{$prestasi->pivot->waktu}}</a>  </td>

												<td> <a href="#" class="note" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editnote')}}" data-title="Masukan Data">{{$prestasi->pivot->note}}</a>  </td>
									...
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printprestasi')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>							
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smp17->catatan as $catatan)
											<tr>
												<td>{{$catatan->note}}</td>

												<td> <a href="#" class="sifat" data-type="text" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editsifat')}}" data-title="Masukan Data">{{$catatan->pivot->sifat}}</a>  </td>

												<td> <a href="#" class="nulis" data-type="date" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smp17') }}/{{$smp17->id}}/{{('editnulis')}}" data-title="Masukan Data">{{$catatan->pivot->nulis}}</a>  </td>
											</tr>
											@endforeach
										</tbody>
									</table>
									<div class="text-left"><a href="{{ url('smp17') }}/{{$smp17->id}}/{{('printcatatan')}}" target="_blank" class="btn btn-success"> Print </a></div>
								</div>
							</div>							
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('smp17')}}/{{$smp17->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
...
<!-- Nilai -->
		<div class="form-group {{$errors->has('namalengkap17') ? 'has-error' : ''}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp17')}}/{{$smp17->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp17')}}/{{$smp17->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp17')}}/{{$smp17->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp17')}}/{{$smp17->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smp17')}}/{{$smp17->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
