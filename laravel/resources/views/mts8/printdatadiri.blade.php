        ...
        <div class="container-fluid">
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts8->nisn38}} </th>
                    <th> {{ $mts8->nik38}} </th>
                    <th> {{ $mts8->tempatlahir38}} </th>
                    <th> {{ $mts8->tbt38}} </th>
                    <th> {{ $mts8->jenkel38}} </th>
                    <th> {{ $mts8->jumlahsaudara38}} </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts8->asalsekolah38}} </th>
                    <th> {{ $mts8->alamatasalsekolah38}} </th>
                    <th> Prestasi yang diraih </th>
            </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          ...
          <table width="100%" border="5" cellspacing="12" cellpadding="6">
            ...
            <tr>
                    <th> {{ $mts8->nokk38}} </th>
                    <th> {{ $mts8->namaayah38}} </th>
                    <th> {{ $mts8->nikayah38}} </th>
                   <th> {{ $mts8->tahunlahirayah38}} </th>
                    <th> {{ $mts8->pendidikanayah38}} </th>
                    <th> {{ $mts8->pekerjaanayah38}} </th>
                    <th> {{ $mts8->namaibu38}} </th>
                    <th> {{ $mts8->nikibu38}} </th>
                    <th> {{ $mts8->tahunlahiribu38}} </th>
                    <th> {{ $mts8->pendidikanibu38}} </th>
                    <th> {{ $mts8->pekerjaanibu38}} </th>
                    <th> {{ $mts8->penghasilan38}} </th>
              </tr>
          </table>
          <!-- _______________________________________________________________________________________ -->
          <!-- _______________________________________________________________________________________ -->
