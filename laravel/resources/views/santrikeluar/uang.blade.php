        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            <div class="panel-heading">
              ...
              <h1 class="panel-title"><b> Daftar Nama yang sudah Registrasi Biaya Awal Masuk Jenjang SMA </b></h1>
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-hover" id="datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>{{ $nomer++}}</th>
                      <td> {{ $registrasi_santrikeluar->status}}  </td>
              ...
              <div>  
               <a href="{{ url('rekapan/administrasi/santrikeluar') }}" class="btn btn-sm btn-succes"> Rekapan Administrasi </a> 
              </div>
