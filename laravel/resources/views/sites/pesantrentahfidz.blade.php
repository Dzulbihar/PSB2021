	...
	<div class="container">				
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="{{url('/')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{url('pesantrentahfidz')}}"> Pesantren Tahfidz</a></p>
			</div>	
		</div>
	</div>
</section>
		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-70 col-lg-8">
				<div class="title text-center">
					<h1 class="mb-10">PESANTREN TAHFIDZ</h1>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-8 left-contents">
				<div class="main-image">
					<img class="img-fluid" src="{{asset('/frontend')}}/lembaga/tahfidz.jpg" >
				</div>
				<br><br>
				<div class="main-image">
					<img class="img-fluid" src="{{asset('/frontend')}}/lembaga/tahfidz2.jpg" >
				</div>	
				<br><br>
				<div class="main-image">
					<img class="img-fluid" src="{{asset('/frontend')}}/lembaga/tahfidz3.png" >
				</div>			
