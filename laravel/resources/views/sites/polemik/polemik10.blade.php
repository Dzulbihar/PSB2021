	...
	<div class="container">				
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="{{url('/')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{url('polemik')}}"> Polemik Masyarakat Pesantren Menjawab</a> <span class="lnr lnr-arrow-right"></span>  <a href="{{url('polemik10')}}"> NASEHAT DARI PONPES ASKHABUL KAHFI SEMARANG </a></p>
			</div>	
		</div>
	</div>
</section>
		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-70 col-lg-8">
				<div class="title text-center">
					<h1 class="mb-10">NASEHAT DARI PONPES ASKHABUL KAHFI SEMARANG</h1>
				</div>
			</div>
		</div>
		<div class="row">
