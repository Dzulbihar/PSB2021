...
<!-- ganti foto -->
							<img src="{{$smktkr->getavatar()}}" width="100" class="img-circle" alt="avatar5">   
<!-- --------------- -->
							<h3 class="name">{{$smktkr->namalengkap}}</h3>
						...
						<div class="profile-stat">
							<div class="row">
								<div class="col-md-4 stat-item">
									{{$smktkr->mapel->count()}} <span>Mata Pelajaran</span>
								</div>
								<div class="col-md-4 stat-item">
									 <span>Data Pelanggaran</span>
								</div>
								<div class="col-md-4 stat-item">
									{{$smktkr->rataRataNilai()}} <span>Total Nilai</span>
								</div>
							</div>
						</div>
<!-- --------------- -->			
					...
					<div class="profile-detail">
						...
						<a href="{{ url('smktkr') }}/{{$smktkr->id}}/{{('edit')}}" class="btn btn-warning">Edit Profile</a>

						<a href="{{ url('smktkr') }}/{{$smktkr->id}}/{{('seratusribu')}}" target="_blank" class="btn btn-success float-right"></i> Print Biaya Registrasi </a>

						<a href="{{ url('smktkr') }}/{{$smktkr->id}}/{{('printsmktkr')}}" target="_blank" class="btn btn-success float-right"></i> Print Data diri </a>

						<a href="{{ url('smktkr') }}/{{$smktkr->id}}/{{('biayaawalmasuk')}}" target="_blank" class="btn btn-danger float-right"></i> Biaya Awal Masuk </a>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->mapel as $mapel)
											<tr>
												<td>{{$mapel->kode}}</td>
												<td>{{$mapel->nama}}</td>
												<td>{{$mapel->kelas}}</td>
												<td> <a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editnilai')}}" data-title="Masukan Nilai">{{$mapel->pivot->nilai}}</a>  </td>
												<td><a href="{{ url('smktkr') }}/{{$smktkr->id}}/{{$mapel->id}}/{{'deletenilai'}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
...
<!-- _______________222222222222222222222222222222_______________________ -->
						<div class="tab-pane fade in active" id="tab-bottom-left2">
							...
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li> Nomor Pendaftaran <span> KR{{ $smktkr->id}} </span></li>
									<li> Nama Lengkap <span> {{ $smktkr->namalengkap}} </span></li>
									<li> Jenjang <span> {{ $smktkr->status}} </span></li>
									<li> Fasilitas <span> {{ $smktkr->fasilitas}} </span></li>
									<li> Tanggal Masuk <span> {{ $smktkr->created_at}} </span></li>
									<li> Tempat Lahir <span> {{ $smktkr->tempatlahir5}} </span></li>
									<li> Tgl/Bulan/Tahun Lahir <span> {{ $smktkr->tbt5}} </span></li>
									<li> Jenis Kelamin <span> {{ $smktkr->jenkel}} </span></li>
									<li> Alamat rt/rw <span> {{ $smktkr->desa}} </span></li>
									<li> Kecamatan <span> {{ $smktkr->kec}} </span></li>
									<li> Kabupaten <span> {{ $smktkr->kab}} </span></li>
									<li> Provinsi <span> {{ $smktkr->prov}} </span></li>
									<li> Asal Sekolah <span> {{ $smktkr->asalsekolah5}} </span></li>
									<li> Alamat Asal Sekolah <span> {{ $smktkr->alamatasalsekolah5}} </span></li>
								</ul>
							</div>
							<div class="col-md-6">
								<ul class="list-unstyled list-justify">
									<li> Nama Ayah <span> {{ $smktkr->namaayah5}} </span></li>
									<li> Pendidikan Ayah <span> {{ $smktkr->pendidikanayah5}} </span></li>
									<li> Pekerja Ayah <span> {{ $smktkr->pekerjaanayah5}} </span></li>
									<li> Nama Ibu <span> {{ $smktkr->namaibu5}} </span></li>
									<li> Pendidikan Ibu <span> {{ $smktkr->pendidikanibu5}} </span></li>
									<li> Pekerjaan Ibu <span> {{ $smktkr->pekerjaanibu5}} </span></li>
									<li> No HP <span> {{ $smktkr->nohp5}} </span></li>
								</ul>									
							</div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->hukuman as $hukuman)
											<tr>
												<td>{{$hukuman->pelanggaran}}</td>

												<td> <a href="#" class="jenis" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editjenis')}}" data-title="Masukan Data">{{$hukuman->pivot->jenis}}</a>  </td>

												<td> <a href="#" class="sanksi" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editsanksi')}}" data-title="Masukan Data">{{$hukuman->pivot->sanksi}}</a>  </td>

												<td> <a href="#" class="skor" data-type="text" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editskor')}}" data-title="Masukan Data">{{$hukuman->pivot->skor}}</a>  </td>

												<td> <a href="#" class="data" data-type="date" data-pk="{{$hukuman->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editdata')}}" data-title="Masukan Data">{{$hukuman->pivot->data}}</a>  </td>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->izin as $izin)
											<tr>
												<td>{{$izin->keperluan}}</td>


												<td> <a href="#" class="rumah" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editrumah')}}" data-title="Masukan Data">{{$izin->pivot->rumah}}</a>  </td>

												<td> <a href="#" class="jangka" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editjangka')}}" data-title="Masukan Data">{{$izin->pivot->jangka}}</a>  </td>

												<td> <a href="#" class="pondok" data-type="date" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editpondok')}}" data-title="Masukan Data">{{$izin->pivot->pondok}}</a>  </td>

												<td> <a href="#" class="datang" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editdatang')}}" data-title="Masukan Data">{{$izin->pivot->datang}}</a>  </td>

												<td> <a href="#" class="hukum" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('edithukum')}}" data-title="Masukan Data">{{$izin->pivot->hukum}}</a>  </td>

												<td> <a href="#" class="ket" data-type="text" data-pk="{{$izin->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editket')}}" data-title="Masukan Data">{{$izin->pivot->ket}}</a>  </td>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->ambil as $ambil)
											<tr>
												<td>{{$ambil->barang}}</td>

												<td> <a href="#" class="pelunasan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editpelunasan')}}" data-title="Masukan Data">{{$ambil->pivot->pelunasan}}</a>  </td>

												<td> <a href="#" class="pengambilan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editpengambilan')}}" data-title="Masukan Data">{{$ambil->pivot->pengambilan}}</a>  </td>

												<td> <a href="#" class="keterangan" data-type="text" data-pk="{{$ambil->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editketerangan')}}" data-title="Masukan Data">{{$ambil->pivot->keterangan}}</a>  </td>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->prestasi as $prestasi)
											<tr>
												<td>{{$prestasi->juara}}</td>

												<td> <a href="#" class="tingkat" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('edittingkat')}}" data-title="Masukan Data">{{$prestasi->pivot->tingkat}}</a>  </td>

												<td> <a href="#" class="kategori" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editkategori')}}" data-title="Masukan Data">{{$prestasi->pivot->kategori}}</a>  </td>

												<td> <a href="#" class="hadiah" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('edithadiah')}}" data-title="Masukan Data">{{$prestasi->pivot->hadiah}}</a>  </td>

												<td> <a href="#" class="waktu" data-type="date" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editwaktu')}}" data-title="Masukan Data">{{$prestasi->pivot->waktu}}</a>  </td>

												<td> <a href="#" class="note" data-type="text" data-pk="{{$prestasi->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editnote')}}" data-title="Masukan Data">{{$prestasi->pivot->note}}</a>  </td>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											@foreach($smktkr->catatan as $catatan)
											<tr>
												<td>{{$catatan->note}}</td>

												<td> <a href="#" class="sifat" data-type="text" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editsifat')}}" data-title="Masukan Data">{{$catatan->pivot->sifat}}</a>  </td>

												<td> <a href="#" class="nulis" data-type="date" data-pk="{{$catatan->id}}" data-url="{{ url('/api/smktkr') }}/{{$smktkr->id}}/{{('editnulis')}}" data-title="Masukan Data">{{$catatan->pivot->nulis}}</a>  </td>
...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<form action="{{url('smktkr')}}/{{$smktkr->id}}/addnilai" method="POST" enctype="multipart/form-data" >
				{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr')}}/{{$smktkr->id}}/adddata"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
<!-- Hukuman -->
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr')}}/{{$smktkr->id}}/addpulang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr')}}/{{$smktkr->id}}/addbarang"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr')}}/{{$smktkr->id}}/addhebat"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<form action="{{url('smktkr')}}/{{$smktkr->id}}/adddeskripsi"  method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
